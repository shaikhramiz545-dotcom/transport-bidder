...
// 1. CORS Configuration — MUST be before helmet/rate-limiter so preflight
//    OPTIONS requests get proper Access-Control-Allow-Origin headers.
const allowedOrigins = process.env.ALLOWED_ORIGINS 
  ? process.env.ALLOWED_ORIGINS.split(',').map(o => o.trim()) 
  : ['https://t-bidder.netlify.app', 'https://admin.transportbidder.com', 'https://tbidder-admin.web.app', 'http://admin.transportbidder.com.s3-website.ap-south-1.amazonaws.com', 'https://d3io043wgedrnl.cloudfront.net', 'http://localhost:3000'];
